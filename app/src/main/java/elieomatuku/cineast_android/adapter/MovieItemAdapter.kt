    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (viewType) {
            TYPE_MOVIE_PROFILE -> {
                ...
                movieProfileHolder.update(movieInfo.movie, movieInfo.genres, movieInfo.movieDetails?.homepage)
            }
            ...
            TYPE_MENU_MOVIE -> {
                ...
                menuMovieHolder.overviewSegmentBtn.setOnClickListener {
                    ...
                    val overviewFragment = OverviewFragment.newInstance(movieInfo.movie, movieInfo.trailers, movieInfo.movieDetails)
                ...
                menuMovieHolder.peopleSegmentBtn.setOnClickListener {
                    val activity =  it.context as FragmentActivity
                    val peopleFragment = MovieTeamFragment.newInstance(movieInfo.cast, movieInfo.crew, movieInfo.movie?.title)
                ...
                menuMovieHolder.similarSegmentBtn.setOnClickListener {
                    val activity =  it.context as FragmentActivity
                    val similarFragment = SimilarMovieFragment.newInstance(movieInfo.similarMovies, movieInfo.movie?.title)
