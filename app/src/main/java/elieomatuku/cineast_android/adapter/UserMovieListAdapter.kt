...
class UserMovieListAdapter(private val movies: List<Movie>, onItemClickPublisher: PublishSubject<Movie>,
                           itemListLayoutRes: Int? = null, private val onMovieRemovedPublisher: PublishSubject<Movie>? = null)
    : MovieListAdapter(movies, onItemClickPublisher, itemListLayoutRes) {
