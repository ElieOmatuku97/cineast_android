...
class MovieActivityTest {
    ...
    val movie = Movie(poster_path = "/xBHvZcjRiWyobQ9kxBhO6B2dtRI.jpg", adult = false,
    ...
    fun registerIdlingResource() {
        ...
        activityScenario.onActivity(ActivityScenario.ActivityAction<MovieActivity> { activity ->
