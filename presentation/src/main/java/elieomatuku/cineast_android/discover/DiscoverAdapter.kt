...
class DiscoverAdapter(
    ...
    var filteredContents: MutableMap<Int, DiscoverWidget> by Delegates.observable(mutableMapOf()) { prop, oldDiscoverContent, nuDiscoverContent ->
        hasValidData = true
        errorMessage = null
    }
    ...
    override fun onViewRecycled(holder: RecyclerView.ViewHolder) {
        when (holder) {
            ...
            is HeaderHolder -> holder.composeView.disposeComposition()
            is LoginViewHolder -> holder.composeView.disposeComposition()
